...
function FeatureCard({ feature }: FeatureProp) {
  return (
    <div className="w-full bg-white/5 px-5 py-10 md:p-10 rounded-3xl border-white/10 border font-raleway">
      ...
      <div className="w-full font-raleway">
        ...
        <p className="mt-2 text-sm md:text-base text-gray-300 font-light line-clamp-3">{feature.description}</p>
      </div>
    </div>
  );
}
